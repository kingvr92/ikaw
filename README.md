...
--------------------------------------------------------------------
local RenUi = library:CreateWindow("Tara",Color3.fromRGB(255,51,51),"Premium")
--------------------------------------------------------------------
...
Main:AddToggle("เซ็ตจุดเกิดออโต้",true,function(value)
...
Main:AddToggle("ตีเร็ว",true,function(value)
    _G.FastAttack = value
end)

Main:AddToggle("ดึงมอน",true,function(value)
...
Main:AddButton("รีเฟชร อาวุธ",function()
    SelectWeapona:Clear()
    for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do  
...
if World1 then
    Main:AddToggle("ออโต้ไปโลก 2",_G.AutoSecondSea,function(value)
...
if World2 then
    Main:AddToggle("ออโต้ไปโลก 3",_G.AutoThirdSea,function(value)
...
elseif World3 then
    Main:AddToggle("ออโต้หาเกาะลึกลับ",_G.AutoMysticIsland,function(value)
...
Main:AddToggle("ออโต้ทำหมัด superhuman",_G.AutoSuperhuman,function(value)
...
Main:AddToggle("ออโต้ทำ หมัดขาไฟ",_G.AutoDeathStep,function(value)
...
Main:AddToggle("ออโต้ทำหมัดเงือก",_G.AutoSharkman,function(value)
...
Main:AddToggle("ออโต้ทำหมัด สายฟ้าv2",_G.AutoElectricClaw,function(value)
...
Main:AddToggle("ออโต้ทำหมัด มังกรv2",_G.AutoDragonTalon,function(value)
...
Main:AddToggle("ออโต้ฟาร์ม มาสเตอร์รี่ผล",_G.AutoFarmFruitMastery,function(value)
...
Main:AddToggle("ออโต้ฟาร์มมาสเตอร์รี่ ปืน",_G.AutoFarmGunMastery,function(value)
...
Main:AddToggle("ออโต้ ฟาร์มบอส",_G.AutoFarmBoss,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
Main:AddToggle("ออโต้ ฟาร์มบอสทั้งหมดในเซิฟ",_G.AutoAllBoss,function(value)
    _G.AutoAllBoss = value
    StopTween(_G.AutoAllBoss)
end)

Main:AddToggle("ออโต้ ฟาร์มบอสทั้งหมดในเซิฟ รีเซิฟเอง",_G.AutoAllBossHop,function(value)
    ...
    while wait() do
        pcall(function()
            if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
                MobKilled:Set("จำนวนที่เหลือ : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41))
            elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
                MobKilled:Set("จำนวนที่เหลือ : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40))
            elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                MobKilled:Set("จำนวนที่เหลือ : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39))
            else
...
Main:AddToggle("ออโต้ ฟาร์มบอสคาตาคุริ",_G.AutoDoughtBoss,function(value)
...
Main:AddSeperator("ดันเจี้ยน")

Main:AddToggle("ออโต้ตี ดันเจี้ยน",_G.AutoBossLaw,function(value)
    _G.AutoBossLaw = value
    StopTween(_G.AutoBossLaw)
end)

Main:AddToggle("ออโต้ ซื้อชิป",_G.AutoBuyBossLawChip,function(value)
...
Main:AddToggle("ออโต้ทำดาบ มิกมั้ม",_G.AutoBudySword,function(value)
    _G.AutoBudySword = value
    StopTween(_G.AutoBudySword)
end)

Main:AddToggle("ออโต้ทำดาบ มิกมั้ม Hop",_G.AutoBudySwordHop,function(value)
...
Main:AddToggle("ออโต้ ทำเคียว",_G.AutoFarmBossHallow,function(value)
    _G.AutoFarmBossHallow = value
    StopTween(_G.AutoFarmBossHallow)
end)

Main:AddToggle("ออโต้ ทำเคียว hop",_G.AutoFarmBossHallowHop,function(value)
...
Main:AddToggle("ออโต้ทำดาบ โยรุจิ๋ว",_G.AutoDarkDagger,function(value)
...
Main:AddToggle("ออโต้ทำดาบ โยรุจิ๋ว hop",_G.AutoDarkDagger_Hop,function(value)
...
Main:AddToggle("ออโต้ ทำเเว่นตาโดฟา",_G.AutoFarmSwanGlasses,function(value)
...
Main:AddToggle("ออโต้ ทำเเว่นตาโดฟา Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
...
local BoneFarm = Main:AddToggle("ออโต้ฟาร์ม กระดูก",_G.AutoFarmBone,function(value)
...
Main:AddToggle("ออโต้สุ่ม กระดูก",_G.Auto_Random_Bone,function(value)
...
Main:AddToggle("ออโต้ฟาร์ม ฮาคิสังเกต",_G.AutoObservation,function(value)
...
Main:AddToggle("ออโต้ฟาร์ม ฮาคิสังเกต Hop",_G.AutoObservation_Hop,function(value)
...
Main:AddToggle("ออโต้ทำดาบ เซเบอร์",_G.AutoSaber,function(value)
    _G.AutoSaber = value
    StopTween(_G.AutoSaber)
end)

Main:AddToggle("ออโต้ทำดาบ เซเบอร์ Hop",_G.AutoSaber_Hop,function(value)
...
Main:AddToggle("ออโต้หาดาบ รีเจนดารี่",_G.AutoBuyLegendarySword,function(value)
...
Main:AddToggle("ออโต้หาดาบ รีเจนดารี่ Hop",_G.AutoBuyLegendarySword_Hop,function(value)
...
Main:AddToggle("ออโต้หา Musketeer Hat",_G.AutoMusketeerHat,function(value)
...
Main:AddToggle("ออโต้ทำ สีฮาคิเเรมโบ",_G.Auto_Rainbow_Haki,function(value)
...
Main:AddToggle("ออโต้ทำ ฮาคิสังเกตุ v2",_G.AutoObservationv2,function(value)
...
Main:AddToggle("ออโต้ทำดาบ เรนโกคุ",_G.AutoRengoku,function(value)
...
Main:AddToggle("ออโต้ฟาร์ม Ectoplasm",_G.AutoEctoplasm,function(value)
...
Main:AddToggle("ออโต้ทำดาบ ยามะ",_G.AutoYama,function(value)
    _G.AutoYama = value
...
Main:AddToggle("ออโต้ Bartlio Quest",_G.AutoBartilo,function(value)
...
Main:AddToggle("ออโต้หา Holy Torch",_G.AutoHolyTorch,function(value)
...
Combat:AddToggle("ออโต้ฟาร์มค่าหัวผู้เล่น",false,function(value)
...
Combat:AddSeperator("ล็อกเป๋า")

Combat:AddToggle("ล็อกเป๋า ปืน",false,function(value)
    _G.Aimbot_Gun = value
end)
...
Combat:AddToggle("ล็อกเป๋า สกิว",false,function(value)
    _G.Aimbot_Skill = value
end)

Combat:AddSeperator("PvP")

Combat:AddToggle("เปิด pvp ให้ออโต้",false,function(value)
    _G.EnabledPvP = value
end)
...
Combat:AddToggle("เซฟตัวเอง",false,function(value)
    _G.Safe_Mode = value
...
Combat:AddButton("ฆ่าตัวตาย",function()
...
Combat:AddToggle("ออโต้ฟาร์ม ค่าหัว",_G.AutoFarmBounty,function(value)
...
Combat:AddToggle("ออโต้ฟาร์มค่าหัว Hop",_G.AutoFarmBounty_Hop,function(value)
...
Stats:AddSeperator("ออโต้ อัพสเเต็ก")
...
Stats:AddToggle("ออโต้ อัพหมัด",_G.Auto_Melee,function(value)
    _G.Auto_Melee = value
end)

Stats:AddToggle("ออโต้ อัพเลือด",_G.Auto_Defense,function(value)
    _G.Auto_Defense = value
end)

Stats:AddToggle("ออโต้ อัพดาบ",_G.Auto_Sword,function(value)
    _G.Auto_Sword = value
end)

Stats:AddToggle("ออโต้ อัพปืน",_G.Auto_Gun,function(value)
    _G.Auto_Gun = value
end)

Stats:AddToggle("ออโต้ อัพผล",_G.Auto_DevilFruit,function(value)
    _G.Auto_DevilFruit = value
end)

_G.PointStats = 1
Stats:AddSlider("เลือกพ้อย",1,100,1,function(value)
    _G.PointStats = value
end)
...
Dungeon:AddToggle("ออโต้ ซื้อชิป",_G.AutoBuyChip,function(value)
    _G.AutoBuyChip = value
end)

Dungeon:AddToggle("ออโต้ ลงดัน",_G.Auto_StartRaid,function(value)
...
_G.SelectFruit = ""
DevilFruit:AddDropdown("เลือกผลที่จะซื้อ",FruitList,function(value)
    _G.SelectFruit = value
end)

DevilFruit:AddToggle("ออโต้ซื้อผล (เลือกผลด้วยนะ)",_G.AutoBuyFruitSniper,function(value)
...
local SelectFruit = DevilFruit:AddDropdown("เลือกกินผล",FruitsListEat,function(value)
    _G.SelectFruitEat = value
end)

DevilFruit:AddButton("รีเฟชรผล",function()
    SelectFruit:Clear()
    for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
        if v:IsA("Tool") then
            if string.find(v.Name,"Fruit") then
...
DevilFruit:AddToggle("ออโต้กินผล",_G.AutoEatFruit,function(value)
...
DevilFruit:AddToggle("ออโต้ใส่ผลในกล่อง",_G.AutoStoreFruit,function(value)
...
DevilFruit:AddToggle("ดึงผล",_G.BringFruit,function(value)
    _G.BringFruit = value
end)
